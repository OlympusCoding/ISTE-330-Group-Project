...
public class EditPanel extends JPanel {
    ...
    public EditPanel(Portal parent, int userID) {
        ...
        if (abstractString == null) {
            // Add Option
            JLabel addAbstractLabel = new JLabel("Add an Abstract:");
            ...
            addButton.addActionListener(new ActionListener() {
                ...
                {
                    boolean result = fascade.AddFacultyAbstract(userID, addArea.getText());
                    if (!result)
                    {
            ...
            add(abstractLabel);
            JLabel abstractText = new JLabel(abstractString);
            ...
            updatePanel.setMaximumSize(new Dimension(
                    ...
                    JLabel updateAbstractLabel = new JLabel("Update Abstract:");
            ...
            JButton updateButton = new JButton(
                ...
                public void actionPerformed(ActionEvent e)
                {
                    boolean result = fascade.UpdateFacultyAbstract(userID, updateArea.getText());
                    if (!result)
                    {
